...
public class ClickGUI extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.modButtons.add(new ModButton(i, j, 58, k, HudManager.clientName));
        i = this.width / 2 + 105;
        j = this.height / 2 - 125;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 62, k, HudManager.timeMod));
        i = this.width / 2 + 25;
        j = this.height / 2 - 100;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 60, k, HudManager.fpsMod));
        i = this.width / 2 + 105;
        j = this.height / 2 - 100;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 60, k, HudManager.cpsMod));
        i = this.width / 2 + 25;
        j = this.height / 2 - 75;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 60, k, HudManager.xyzMod));
        i = this.width / 2 + 105;
        j = this.height / 2 - 75;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 67, k, HudManager.biomeMod));
        i = this.width / 2 + 25;
        j = this.height / 2 - 50;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 60, k, HudManager.targetHUD));
        i = this.width / 2 + 105;
        j = this.height / 2 - 50;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 68, k, HudManager.directionMod));
        i = this.width / 2 + 25;
        j = this.height / 2 - 25;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 65, k, HudManager.armorStatus));
        i = this.width / 2 + 105;
        j = this.height / 2 - 25;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 70, k, HudManager.potionsStatus));
        i = this.width / 2 + 25;
        j = this.height / 2;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 60, k, HudManager.keystrokesMod));
        i = this.width / 2 + 105;
        j = this.height / 2;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 62, k, HudManager.blockOutline));
        i = this.width / 2 + 25;
        j = this.height / 2 + 25;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 66, k, HudManager.toggleSprint));
        i = this.width / 2 + 105;
        j = this.height / 2 + 25;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 60, k, HudManager.buttonStyle));
        i = this.width / 2 + 25;
        j = this.height / 2 + 50;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 63, k, HudManager.perspectiveMod));
        i = this.width / 2 + 105;
        j = this.height / 2 + 50;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 60, k, HudManager.scrollZoom));
        i = this.width / 2 + 25;
        j = this.height / 2 + 75;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 68, k, HudManager.memoryUsage));
        i = this.width / 2 + 105;
        j = this.height / 2 + 75;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 70, k, HudManager.serverIPMod));
