...
public class CosmeticsMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.modButtons.add(new ModButton(i, j, 65, k, HudManager.cosmeticWings));
        i = this.width / 2 + 105;
        j = this.height / 2 - 125;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 67, k, HudManager.rainbowWings));
        i = this.width / 2 + 25;
        j = this.height / 2 - 100;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 67, k, HudManager.cosmeticDiamonds));
        i = this.width / 2 + 105;
        j = this.height / 2 - 100;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 52, k, HudManager.cosmeticEggs));
        i = this.width / 2 + 25;
        j = this.height / 2 - 75;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 60, k, HudManager.cosmeticHat));
        i = this.width / 2 + 105;
        j = this.height / 2 - 75;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 74, k, HudManager.cosmeticWither));
        i = this.width / 2 + 25;
        j = this.height / 2 - 50;
        k = this.fontRendererObj.FONT_HEIGHT + 4;
        hudmanager = Client.INSTANCE.hudManager;
        this.modButtons.add(new ModButton(i, j, 70, k, HudManager.cosmeticCape));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("Cosmetics Menu", new Object[0]), this.width / 2 - 100, this.height / 2 - 135, -1);
