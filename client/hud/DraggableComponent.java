...
public class DraggableComponent
{
    ...
    public void draw(int mouseX, int mouseY)
    {
        ...
        boolean flag = mouseX >= this.getxPosition() && mouseX <= this.getxPosition() + this.getWidth();
        boolean flag1 = mouseY >= this.getyPosition() && mouseY <= this.getyPosition() + this.getHeight();

        if (flag && flag1 && Mouse.isButtonDown(0) && !this.dragging)
        {
